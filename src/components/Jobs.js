      ...
      <div className="container-jobs">
        ...
        <div className="container-buttons-modals">
          ...
          <div className="border-frame">
            ...
            >
              <img
                src={Cloudy}
                className="cloudy"
                alt="Logo del sitio Cloudy"
                title="Logo de Cloudy"
              />
              <p>Cloudy</p>
            </div>
          </div>
          <div className="border-frame">
            ...
            >
              <img
                src={BroPets}
                alt="Logo del sitio BroPets"
                title="Logo de BroPets"
              />
              <p>BroPets</p>
            </div>
          </div>
        ...
        <div className="container-modals">
          ...
          >
            <img
              src={CapturaNpNg}
              alt="Captura realizada al sitio web de NpNg"
              title="Captura de NpNg"
            />
          </Modals>
          <Modals
            estado={stateModal1}
          ...
          >
            <img
              src={CapturaCloudy}
              alt="Captura realizada al sitio web de Cloudy"
              title="Captura de Cloudy"
            />
          </Modals>
          <Modals
            estado={stateModal2}
          ...
          >
            <img
              src={CapturaBroPets}
              alt="Captura realizada al sitio web de BroPets "
              title="Captura de BroPets"
            />
          </Modals>
        </div>
      </div>
